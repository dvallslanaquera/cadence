...
export const DICTIONARY: Record<string, Translations> = {
  ...
  "dash.range.month": { en: "This month", es: "Este mes", fr: "Ce mois-ci", it: "Questo mese", ja: "今月" },
  "dash.range.last30": { en: "Last 30 days", es: "Últimos 30 días", fr: "30 derniers jours", it: "Ultimi 30 giorni", ja: "過去30日" },
  "dash.range.year": { en: "This year", es: "Este año", fr: "Cette année", it: "Quest'anno", ja: "今年" },
